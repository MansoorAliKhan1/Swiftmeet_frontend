...
const Homepage = () => {
  ...
  <label style={{ color: 'white', fontSize: '35px', alignItems: 'center', fontFamily:'monospace' ,paddingTop:'5px' }}>SwiftMeet</label>
</div>
<div className=''>
<ul className="flex">
<li className="p-5 text-white hover:bg-gray-900 transition duration-300">
  <button onClick={handleRecordsclick} style={{fontFamily:'monospace'}}>
    savedRecordings
  </button>
</li>
  <li className="p-5 text-white hover:bg-gray-900 transition duration-300">
    <Link style={{fontFamily:'monospace'}} to="/">logOut</Link>
  </li>
</ul>
  </div>
 ...
 <div style={{width:'100%',textAlign:'center',marginTop:200, alignItems:'center',paddingLeft:'200px'}}>
{/* <div><p className='text-gray-50 mb-4'>please enter purpose of meeting to start or create meeting </p></div> */}
        <input 
          ...
          onChange={handleInputChange} 
          style={{fontFamily:'monospace', width:'500px'}}
        />
        <button onClick={handleMeeting} className='bg-blue-400 hover:bg-blue-350 ml-2 rounded py-2 px-6 text-xl font-mono'style={{fontSize:'13px',color:'white'}} >
        {isMeetingHost ? 'StartMeeting' : 'JoinMeeting'}
      </button>
 </div>
