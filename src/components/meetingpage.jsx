...
// }
  ...
  const copyToClipboard = () => {
    const meetLink = `https://swiftmeet-frontend.vercel.app/user/?meetingId=${meet}`;
    ...
    setTimeout(() => {
      ...
      <label className="bgblock font-bold  ml-24 font-mono">Meeting Link : </label>
        <span className='text-slate-50 font-mono'>{`https://swiftmeet-frontend.vercel.app/user/?meetingId=${meet}`}</span>
  ...
  <div style={{ width: '100%', textAlign: 'center', margin: '50px auto' }}>
    {isMeetingHost && (
      <button
        type="button"
        id="stop-button"
        className="mr-4 px-4 py-2 bg-red-500 text-white rounded-full transition duration-300 hover:bg-red-700 mb-4 font-mono"
        onClick={stopMeeting}
      >
        Stop Meeting
      </button>
    ...
    <RecordVideoComponent ismeetinghost={isMeetingHost} />
       ...
       <>{isMeetingHost &&  <div className='text-center  text-neutral-50 align-middle content-center font-mono'>
        <h1>Meeting Ended</h1>
      ...
      {!isMeetingHost&&(
        ...
        <div className='text-center  text-neutral-50 align-middle content-center font-mono'>
          <h1>Meeting Ended</h1>
          <div style={{ display: 'none' }}>
            <div id="video-list"></div>
          </div>
          <Link to="/"><h className='underline font-mono'>Click here to go back home</h></Link>
        </div>
