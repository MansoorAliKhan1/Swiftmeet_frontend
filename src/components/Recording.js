...
const RecordVideoComponent = (props) => {
  ...
  className="px-4 py-2 bg-blue-400 text-white rounded-full transition duration-300 hover:bg-blue-700 mr-2 font-mono"
>
  Start Recording
</button>
...
<button
  ...
  disabled={!recording || saved}
  className="px-4 py-2 bg-red-500 text-white rounded-full transition duration-300 hover:bg-red-700 mr-2 font-mono"
>
  Stop Recording
</button>
{recording && <div className="text-green-500 mb-2 font-mono">Recording...</div>}
      {recordingStopped && <div className="text-red-500 mb-2 font-mono">Recording stopped.</div>}
          ...
          <div className='w-1/3'>
            ...
            {ismeetinghost &&(
              <>
                ...
                {saved === 'saving' && <div className='text-slate-50 font-mono'>Saving Your Video, Please Wait...</div>}
                {saved === 'success' && <div className='text-slate-50 font-mono'>Video Saved Successfully!</div>}
                </>
            )}
          </div>
          </>
